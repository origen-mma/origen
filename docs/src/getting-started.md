...
- **System libraries** (Linux): `libcfitsio-dev libsasl2-dev libfontconfig1-dev`
- **System libraries** (macOS): `brew install cfitsio cyrus-sasl`
...
# Edit config/config.toml with your GCN and BOOM credentials
```
